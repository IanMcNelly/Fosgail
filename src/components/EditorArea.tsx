...
export default function EditorArea({
  ...
  // ⚡ Bolt Optimization: Use String.indexOf and pre-allocated arrays.
  // indexOf is significantly faster than charCodeAt in JS, and pre-allocated arrays
  // avoid the overhead of Array.from, preventing GC pauses during typing.
